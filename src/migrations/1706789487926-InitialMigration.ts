...
export class InitialMigration1706789487926 implements MigrationInterface {
    name = 'InitialMigration1706789487926'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "purchase_order_item" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "price" numeric(15,2) NOT NULL, "product_id" uuid, "purchaseOrderId" uuid, CONSTRAINT "PK_f3eaf81afb216ae78a59cc19503" PRIMARY KEY ("id"))`);
